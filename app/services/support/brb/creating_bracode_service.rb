module Support
  module Brb
    class CreatingBarcodeService # :nodoc:
      ...
      # => cap 1 - manual brb
      def brb_keys
        Support::Brb::CalculateSupport.new(brb_key_without_digits).calc!
      end
      ...
      def group_one_with_digit
        digit = Support::Brb::CalculateSupport.new(group_one_without_digit).calc_module_10
      ...
      def group_two_with_digit
        digit = Support::Brb::CalculateSupport.new(group_two_without_digit).calc_module_10
      ...
      def group_three_with_digit
        digit = Support::Brb::CalculateSupport.new(group_three_without_digit).calc_module_10
      ...
      def barcode_digit
        Support::Brb::CalculateSupport.new(barcode_without_digit).calc_module_11_barcode
      end
