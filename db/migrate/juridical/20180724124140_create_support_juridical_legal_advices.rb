class CreateSupportJuridicalLegalAdvices < ActiveRecord::Migration[5.2] # :nodoc:
  def change
    create_table 'extranet.juridical_legal_advices' do |t|
      ...
      t.decimal :condemnation_value, precision: 12, scale: 2
      t.decimal :lawsuit_value, precision: 12, scale: 2
      ...
      t.decimal :procedural_costs, precision: 12, scale: 2
      t.decimal :judicial_deposit, precision: 12, scale: 2
